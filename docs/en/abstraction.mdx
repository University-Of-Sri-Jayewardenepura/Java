...
Abstraction hides implementation details and exposes only the essential features of an object. It focuses on _what_ an object does rather than _how_ it does it.
